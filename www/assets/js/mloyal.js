...
var json_fb='https://taghash.co/mloyalApps/facebookdaimler.php';
var RSS_twitter='https://taghash.co/mloyalApps/twitter.php?uname=daimlerhome';
var RSS_pinterest='http://103.25.128.61/projects/taghash/mloyalApps/pinteresttantra.php?brand=daimler';
var RSS_instagram='https://www.instagram.com/daimler/?__a=1';
var RSS_youtube='http://xceedfbapps.com/mloyalfeeds/youtube.php?brandname=daimler';
var RSS_tumblr='http://xceedfbapps.com/mloyalfeeds/tumblr.php?brandurl=http://daimler.tumblr.com';

var brandname='daimler';
var aboutus_det='daimler';
var brand_url='https://www.bharatbenz.com/';
var cart = { cartdata: []};
...
var SERVER = "https://daimlertrucks.mloyalretail.com/m/";
var SERVER1 = "https://daimlertrucks.mloyalretail.com/";
var SERVER2 = "https://daimlertrucks.mloyalretail.com/APIs/";
var SERVER3 = 'https://daimlertrucks.mloyalretail.com/Rewards/';
var GSERVER2 = "https://daimlertrucks.mloyalretail.com/APIs/";
//var shopcmsurlnew = 'https://taghash.co/mloyalshops/ocado/';

var gbrd='EEDB9B2B-9F25-4304-8C54-9F003441177B';
//var gbrd='103CF82B-4D66-4A8C-B884-5CA6D4E4B7C8';
...
$(document).ready(function(event){
				...
				localStorage.setItem('selectedstoredaimler',gbrd);
				...
				document.addEventListener("backbutton", function(e)
				{
					   ...
					   else 
					   {
						   navigator.app.backHistory();
				            ...
				            if(localStorage.getItem("usernamedaimler")!=null && localStorage.getItem("usernamedaimler")!='' && localStorage.getItem("passworddaimler")!=null && localStorage.getItem("passworddaimler")!='')
							{
									$('#username').val(localStorage.getItem("usernamedaimler"));
									$('#password_myacc').val(localStorage.getItem("passworddaimler"));
									user.mobile = localStorage.getItem('usernamedaimler');
									var pwd = localStorage.getItem('passworddaimler');
									...
									user.store_code_daimler = localStorage.getItem('store_code_daimler');
									...
									document.getElementById("profilenm").innerHTML= 'Welcome back '+user.firstname+ '!';
									...
									document.getElementById("card_type").innerHTML=user.membership_slab;
									document.getElementById("pr_valid").innerHTML = 'Valid Thru:'+user.validity;
									
									 $("#wait").css("display","none");
									 authenticate();
									 /*if(imageExists('https://taghash.co/mloyalfileupload/uploads/daimler_'+localStorage.getItem("usernamedaimler")+'.jpg'))
									 {
										 document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/daimler_'+localStorage.getItem("usernamedaimler")+'.jpg';
									 }*/                  
							 }
							 else if(localStorage.getItem("usernamedaimler")!=null && localStorage.getItem("usernamedaimler")!='' && (localStorage.getItem("passworddaimler")==null || localStorage.getItem("passworddaimler")=='')) 
							 {
...
function checkapp_Version()
{
     ...
     $.getJSON(
            'https://taghash.co/daimler/getapp_version.php', 
			{

			},
		    function (json) {

				 localStorage.setItem("daimler_vcode", JSON.stringify(json));
			...
			success: function(data, textStatus, xhr) {
			 ...
			 if(data.toLowerCase()=='success'){
				 ...
				 toast('Passcode has been sent to your mobile.Please check your SMS.');
			      ...
			      $('#username').val(mob);
				  localStorage.setItem('usernamedaimler',mob);
    ...
    success: function(data, textStatus, xhr) {
     ...
     console.log('data'+JSON.stringify(data));
		...
		else
		{
			...
			localStorage.setItem('usernamedaimler',uname);
...
function authenticate()
{
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   if(data.status=='success'){
	...
	user.membership_slab = checkforundefined(data.slabname);

	if(user.cpns==null || user.cpns=='null' || user.cpns=='undefined')
		user.cpns='0';
	if(user.membership_slab=='' || user.membership_slab==null || user.membership_slab=='null' || user.membership_slab=='undefined')
		user.membership_slab='Silver Member';
   ...
   localStorage.setItem('usernamedaimler',uname);
   localStorage.setItem('passworddaimler',pwd);
 ...
 if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
    ...
    {
	    if(localStorage.getItem("profiledone_daimler")){
			//document.getElementById("profilepts").innerHTML=user.balance;
	if(user.firstname=='undefined' || user.firstname=='null' || user.firstname==null || user.firstname=='')
	{
		document.getElementById("profilenm").innerHTML= 'Welcome back Guest !';
		document.getElementById("profilenm1").innerHTML='Guest';
	}
	else
	{
    ...
    error: function(xhr, textStatus, errorThrown) {
	user.mobile = localStorage.getItem('usernamedaimler');
	pwd = localStorage.getItem('passworddaimler');
	uname = user.mobile;
    user.balance = localStorage.getItem('balance');
    user.firstname = localStorage.getItem('firstname');
    user.lastname = localStorage.getItem('lastname');
 ...
 if(uname=='' || pwd==''){
  ...
  $.ajax({
   ...
   if(data.status=='success'){
    ...
    user.dob = data.dob;
    user.emailid = data.emailid;
	user.store_code_daimler = data.storecode;
	user.def_store = data.store;
	user.def_city = data.store_city;
	user.visit_frequency = data.visit_frequency;
   ...
   // localStorage.setItem('passworddd',pwd);
	 ...
	 if(user.mobile=='undefined' || user.mobile=='null' || user.mobile==null)
			user.mobile = '';
	 if(user.store_code_daimler=='undefined' || user.store_code_daimler=='null' || user.store_code_daimler==null)
			user.store_code_daimler = 'HO-001';
	...
	else
	{
	 ...
	 $.ajax({
			...
			success: function(data, textStatus, xhr) {
				...
				localStorage.setItem("profiledone_daimler","Yes");
...
function showRewards(){
	...
	openInWebView('https://daimlertrucks.mloyalretail.com/microsite/');
	//RewardsNA();
	/*
	if(user.mobile==null || user.mobile=='')
	{
...
var tabserver='';
	...
	{
		tabserver = "https://daimlertrucks.mloyalretail.com/Rewards/";
	}
    else
	{
		tabserver = "https://daimlertrucks.mloyalretail.com/m/";
	}
	$.getJSON(
		tabserver+url, {
		//page: url,
...
function renderTemplate(pageID, json) {
	...
	case 'specials':
		...
		if(json.length == 0)
		{
			str = '<div style="text-align:center;">No offers found</div>';
		}
		else
		{
	...
	case 'inbox':
		...
		for(var i=0;i<json.length;i++ )
		{
			...
			str += '<span class="msghdr">DM-Daimle</span>';
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json);
          ...
          localStorage.setItem('facebook_daimler',JSON.stringify(json.item));
		 ...
		 try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('facebook_daimler')));
		 }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.feed.entry);
          ...
          localStorage.setItem('youtube_daimler',JSON.stringify(json.feed.entry));
		   ...
		   try{
			 renderTemplate(id,JSON.parse(localStorage.getItem('youtube_daimler')));
		   }
		   catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
...
else if(url==RSS_twitter)
{
  ...
  $.ajax({
            ...
            localStorage.setItem('twitter_daimler', JSON.stringify(data));
                },
                error: function (xhr, textStatus, errorThrown) {
				...
				{
					renderTemplate(id, JSON.parse(localStorage.getItem('twitter_daimler')));
					//alert('here in catch');
				}
  ...
  $.getJSON(
     url, {
         ...
         renderTemplate(id, json.body);
          ...
          localStorage.setItem('pinterest_daimler',JSON.stringify(json.body));
		   ...
		   try{
			    renderTemplate(id,JSON.parse(localStorage.getItem('pinterest_daimler')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_tumblr)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('tumblr_daimler',JSON.stringify(json.channel.item));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('tumblr_daimler')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
else if(url==RSS_instagram)
{
  ...
  $.getJSON(
     url, {
        ...
        //  localStorage.setItem('twitter',JSON.stringify(json.responseData.feed.entries));
       localStorage.setItem('instagram_daimler',JSON.stringify(json.user));

    

       }).error(function () {
		   try{
			   renderTemplate(id,JSON.parse(localStorage.getItem('instagram_daimler')));
		   }catch(err)
		   {
         alert("Error: Could not connect to Server, make sure you are connected to Network");
		   }
...
function receivedEvent(id) {
 ...
 var push = PushNotification.init({ "android": {"senderID": "461785186603"}});
...
function addincart(i)
{
	...
	cart.cartdata.push({ 
   "index":i,
   "url" : "https://daimlertrucks.mloyalretail.com/"+jsonary[i].brand_logo,
...
function checkout(){
  ...
  $.ajax({
    url: 'https://daimlertrucks.mloyalretail.com/Rewards/complete.asp',
    type: 'GET',
    timeout: 50000,
...
function giftfriend(){
  ...
  var val=$('#giftpt').val();
  $.ajax({
    url: 'https://daimlertrucks.mloyalretail.com/m/gift_points_api.asp',
    type: 'GET',
    timeout: 50000,
    dataType: 'text', //xml/html/script/json/jsonp
...
function shareApp()
{
	window.plugins.socialsharing.share('Hi, Join BharatBenz Rewards.', null, 'https://taghash.co/shareimg/daimler.jpg', 'https://daimlertrucks.mloyalretail.com/mapp');
}
		 ...
		 if (deviceType=='iPad' || deviceType=='iPhone') 
			 {
				...
				window.open('https://daimlertrucks.mloyalretail.com/mapp');
			 } 
		 else if (deviceType=='Android') 
			 {
               window.open("market://details?id=com.mobiquest.daimlertrucks","_system");
...
{
	var ref = window.open('https://www.facebook.com/bharatbenz1/', '_blank');
}

function showTwitterNew_1()
{
	var ref = window.open('https://twitter.com/BharatBenz1/', '_blank');
}

function showInstagramNew_1()
{
	var ref = window.open('https://www.instagram.com/bharatbenz/', '_blank');
}

function showYoutubeNew_1()
{
	var ref = window.open('https://www.youtube.com/user/BharatBenzTrucks1', '_blank');
}
...
function showShop()
{
    //openInWebView('https://www.bharatbenz.com/');
	var ref = window.open('https://www.bharatbenz.com/', '_blank');
...
$("input[type=file]").change(function(){
  ...
  // alert($("input[type=file]")[0].files[0]);
	...
	aFormData.append("mobile", localStorage.getItem("usernamedaimler"));
    aFormData.append("brand", "daimler");
	...
	$.ajax(
    {
      ...
      success     : 
        function(data)
        {
         ...
         document.getElementById("cardImagemenu").src='https://taghash.co/mloyalfileupload/uploads/daimler_'+localStorage.getItem("usernamedaimler")+'.jpg';
      //   document.getElementById("cardImage").src='http://103.25.128.61:9296/mloyalfileupload/uploads/daimler_'+localStorage.getItem("usernamedaimler")+'.jpg';
        }
    });
...
function logoutApp()
{
	localStorage.removeItem("usernamedaimler");
	localStorage.removeItem("passworddaimler");

	localStorage.removeItem("profiledone_daimler");
...
function uploadPhoto(imageURI) {
				...
				var fName='daimler_'+user.mobile;
...
//    });
	...
	function gotomembership()
	{
		...
		$("#points").css('display', 'none');
		    ...
		    document.getElementById("cardid").innerHTML = uuu;
		    document.getElementById("valid").innerHTML = 'Valid Thru:'+user.validity;
			document.getElementById("tpoint").innerHTML = 'POINTS : <span>'+user.balance+'</span>';
  ...
  var amount = $('#kyc_paytm_amount').val();
	...
	else
	{
	   ...
	   if(userid.indexOf("@")>=0)
	   {
		  ...
		  $.ajax({
			url: "https://taghash.co/grati/daimler/send.php",
		    type: 'POST',
		    timeout: 7000,
		    dataType: 'json',
		    data:JSON.stringify({
...
function checkNotification_none()
{
  ...
  $.ajax({
	...
	timeout: 50000,
	dataType: 'json',
	data: {'mno': localStorage.getItem('usernamedaimler')},
	complete: function(xhr, textStatus) { 
	},
	success: function(data, textStatus, xhr) {
...
function gotomessages_membership()
{
 ...
 $.ajax({
	...
	success: function(data, textStatus, xhr) {
		...
		if(data.length>0)
		{
			...
			str +=' <ul id="MsgUl" class="messages mt-40">';
			for(var i = 0; i < data.length; i++)
			{
				...
				str += '<div class="MsgBdr">';
				str += '<span class="msghdr">DM-Daimle</span>';
				str += '<span class="msgTime">'+data[i].msgtime+'</span>';
				str += '<span class="msgDate">' + data[i].msgdate + '</span>';
				str += '</div>';
				str += '<div class="msg_body">';
				str += '<span class="msgTxt">'+data[i].msg+'</span>';
				str += '</div>';
				str += '</div>';
				str += '</li>';
			}
		...
		{     
			  ...
			  document.getElementById("message").innerHTML = 'No msg Available!!';
		}
 ...
 $.ajax({
	...
	success: function(data, textStatus, xhr) {
		...
		if(data.length>0)
		{
			...
			str +=' <ul id="MsgUl" class="messages mt-20">';
			for(var i = 0; i < data.length; i++)
			{
			...
			document.getElementById("inbox_div").innerHTML = str;
		...
		{     
			  //localStorage.setItem("notseen_count","0");
			  document.getElementById("inbox_div").innerHTML = '<span style="text-align:center;">No msg Available!!</span>';
		}
...
function checkWarranty()
{
	var str='';
					...
					str +='<tr><td>Refrigerator</td><td>daimler Eon Astra 280</td><td>04/03/2022</td></tr>';
...
function check_gst_alreay_exist(str,gst)
{
		 ...
		 $.ajax({
			url: 'https://taghash.co/daimler/validategst.php',
			type: 'GET',
			timeout: 300000,
            dataType: "json",
            data: {
...
function check_pan_alreay_exist(str,pancardno)
{
		 ...
		 $.ajax({
			url: 'https://taghash.co/daimler/validatepan.php',
			type: 'GET',
			timeout: 300000,
            dataType: "json",
            data: {
...
function check_aadhar_alreay_exist(str,aadhar)
{
		 ...
		 $.ajax({
			url: 'https://taghash.co/daimler/validateid.php',
			type: 'GET',
			timeout: 300000,
            dataType: "json",
            data: {
...
function uploadPhoto_shop(imageURI) 
{
				...
				shop_img="https://taghash.co/daimler/uploads/"+options.fileName+".jpg";
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/daimler/upload_photo_new.php"), win, failPhoto_shop, options, true);
}
...
function uploadPhoto_pan(imageURI) 
{
				...
				pan_img="https://taghash.co/daimler/uploads/"+options.fileName+".jpg";
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/daimler/upload_photo_new.php"), win, failPhoto_pan, options, true);
}
...
function capturePhoto_aadhar(imageURI) 
{
				...
				aadhar_img="https://taghash.co/daimler/uploads/"+options.fileName+".jpg";
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/daimler/upload_photo_new.php"), win, failPhoto_aadhar, options, true);
}
...
function setToday_date()
{
	...
	if(localStorage.getItem("todaydate_daimler"))
	{
		var set_date = localStorage.getItem("todaydate_daimler");

		if(current_date.toString() != set_date.toString())
		{
			console.log('not same');
			localStorage.setItem("todaydate_daimler",current_date);
...
function checkScan_count()
{
	...
	var s_date = localStorage.getItem("todaydate_daimler");
...
function uploadPhoto_shop_byse(imageURI) 
{
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/daimler/upload_photo_new.php"), win, failPhoto_shop_byse, options, true);
}
...
function uploadPhoto_pan_byse(imageURI) 
{
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/daimler/upload_photo_new.php"), win, failPhoto_pan_byse, options, true);
}
...
function uploadPhoto_aadhar_byse(imageURI) 
{
				...
				ft.upload(imageURI, encodeURI("https://taghash.co/daimler/upload_photo_new.php"), win, failPhoto_aadhar_byse, options, true);
}
...
function getBalance()
{
	...
	$.ajax({
					...
					success: function(data, textStatus, xhr) {
						  ...
						  document.getElementById("tpoint").innerHTML = 'POINTS : <span>'+data.balance+'</span>';
						  document.getElementById("profilepts1").innerHTML=data.balance;
...
function showCategory_new()
{
  	$.mobile.changePage( "#products", { transition: "none"} );
	   ...
	   $.ajax({
		...
		success: function(data, textStatus, xhr) {
			  ...
			  for (var i = 0; i < data.data.length; i++)
			  {
				...
				str2+='<li><a href=javascript:showdiv(\'menuh'+data.data[i].catid+'\');>'+checkforundefined(data.data[i].catname)+'</a></li>';
			...
			$('.recommened_carousel').owlCarousel({
				...
				autoplay:true
				 ...
				 document.getElementById("products_div").innerHTML=str1;
						...
						str +='</div><div class="ui-block-a">'+
						        ...
						        if(pointval!='')
								{
									...
									str += '<div class="cart_qty_bshop">'+	
									       '<button onclick="javascript:showRewardDetails(\''+product_id+'\',\''+blogo+'\',\''+bname+'\',\''+bdesc+'\',\''+pointval+'\',\''+brand_id+'\')" class="add_btn">Redeem</button><br>'+
									       '</div>';
...
function showCategory_()
{
	...
	//var loc= localStorage.getItem('selectedstoredaimler');
	var loc= '10';

	'use strict';	
	   $.ajax({
		 url: shopcmsurlnew+'getcat/getloccats/'+loc,
		 type: 'GET',
		 timeout: 50000,
		 dataType: 'json',
		 data: { },
		...
		success: function(data, textStatus, xhr) {
			  ...
			  for (var i = 0; i < data.length; i++)
			  {
				...
				var cat_img = '';
				if(typeof data[i].image == undefined ||typeof data[i].image == 'undefined' || data[i].image == null || data[i].image == 'null' || data[i].image == '' || data[i].image=='https://taghash.co/mloyalshops/daimler/uploads/categories/v2logo1.png' )
                {
			...
			$('.recommened_carousel').owlCarousel({
				...
				for(var i=0;i<data.length;i++)
				{
					addProducts_new(data[i].id,data[i].name,data[i].gst);
				}
      ...
      var mylist = JSON.parse(localStorage.getItem("shoppingcartdaimler"))||[];
...
function addProducts_new(cid,cname,gst)
{  
	...
	//document.getElementById("cat_header").innerHTML='<span>'+cname+'</span>';
	//$.mobile.changePage( "#products");
	//var mywishlist = JSON.parse(localStorage.getItem("mywishlistitemdaimler"))||[];
	var mycartlist = JSON.parse(localStorage.getItem("shoppingcartitemdaimler"))||[];
    var mylist = JSON.parse(localStorage.getItem("shoppingcartdaimler"))||[];
	...
	globalcname = cname;
	   $.ajax({
		 url: shopcmsurlnew+'getcat/getitems/'+loc+'/'+cid,
		 type: 'GET',
		 timeout: 50000,
		 dataType: 'json',
		 data: { },
                   ...
                   if(data[i].colum9=='green_dot' || data[i].colum9=='null' || data[i].colum9=='' || data[i].colum9=='0')
                    {
						...
						str +='<div class="ui-grid-a"><div class="ui-block-a">'+
								...
								if(mycartlist.indexOf(data[i].itemcode)>=0)
								{
	                    			...
	                    			mylist = JSON.parse(localStorage.getItem("shoppingcartdaimler"));
					...
					else
					{
						...
						if(data[i].description=='' || data[i].description==null || data[i].description=='null' || data[i].description=='undefined')
						{
...
var mylist = JSON.parse(localStorage.getItem("shoppingcartdaimler"))||[];
var myaddonlist = JSON.parse(localStorage.getItem("addoncartdaimler"));
...
localStorage.setItem("shoppingcartdaimler",JSON.stringify(mylist));
//console.log('in buyfromshop'+JSON.stringify(mylist));
var mycartlist = JSON.parse(localStorage.getItem("shoppingcartitemdaimler"))||[];
if(mycartlist.indexOf(code)==-1)
mycartlist.push(code);
localStorage.setItem("shoppingcartitemdaimler",JSON.stringify(mycartlist));
var pstr ='';
var pdetstr ='';
...
for(var i=0;i<mylist.length;i++)
	{
		...
		if(elem[4]!='0')
		{
					...
					localStorage.setItem("id_strdaimler",id_str);
...
//str +='<br><h3 class="menu_heading">Recommendations</h3><div id="p_recomenddiv"></div>';
					//str +='<div class="cart_item">';
					//str +='<input type="text" class="instructions_input" id="special_instructions" data-role="none" placeholder="Any request for the restaurant">';
					//str +='</div>';


					/*var deliverytype = localStorage.getItem("deliverytypedaimler");
	...
	str+='<div class="col-sm-5 hidden-xs" style="padding:0 10px">Promo code :</div><div class="col-sm-7 text-right" style="padding:0 10px"><input type="text" id="ccode" name="ccode" class="promo_input" placeholder="Promo Code" value=""  /><a href="javascript:getdiscount();" data-inline="true" class="btnclass3 ui-link">Apply</a></div>';
	str+='</div>';

	}*/

    
    /* checking for min order 195 */

    
	str+='<div class="text-center mt-20" id="pay_btn"><a href="javascript:getviewcart();" data-role="none" class="cart_btn">Proceed</a></div>';
...
localStorage.setItem('totalamtdaimler',total_amt);
localStorage.setItem('payableamtdaimler',famt);	
localStorage.setItem('taxdaimler',totaltax);	
localStorage.setItem('deliverychargedaimler',deliverycharge);
localStorage.setItem('discountdaimler',discount);
...
function remfromshop(code,id,name,mrp,index,qtytxt,size,imglink,gst,variable)
{
	...
	for(var i=0;i<mylist.length;i++)
	{
        ...
        for(var j=0;j<myaddonlist.length;j++)
			...
			localStorage.setItem("addoncartdaimler",JSON.stringify(myaddonlist));
         /*$.ajax({
		   ...
		   timeout: 50000,
			...
			success: function(data, textStatus, xhr) {
				...
				if(data.length>0)
				{
				    ...
				    for (var i = 0; i < data.length; i++)
					{
						if(data[i].storename.indexOf('Email Admin')==0 || data[i].storename.indexOf('ONLINE')==0  || data[i].storename.indexOf('online')==0 || data[i].storename.indexOf('Facebook')>=0 || data[i].storename.indexOf('Head Office')>=0 || data[i].storename.indexOf('Mobile App')>=0 || data[i].storename.indexOf('MicroSite')>=0 || data[i].storename.indexOf('QR Code')>=0 || data[i].storename.indexOf('Paytm App Store')>=0 || data[i].storename.indexOf('ShortCode')>=0)
						continue;
						var lat2 = checkforundefined(data[i].storelatitude).trim();
						var lon2 = checkforundefined(data[i].storelongitude).trim();
						...
						if(d<20)
						{
							...
							store_namearr.push(data[i].storename);
							//store_locarr.push(data[i].storelocation);
							store_addarr.push(data[i].storeaddress);
							store_contact.push(data[i].CustomerCare);
							store_lat.push(data[i].storelatitude);
							store_long.push(data[i].storelongitude);
						}
			 ...
			 if(storearr.length>=1)
			 {
				  ...
				  for (var i = 0; i < storearr.length; i++)
				  {
				        ...
				        if(store_namearr[i].indexOf('Email Admin')==0 || store_namearr[i].indexOf('ONLINE')==0 || store_namearr[i].indexOf('Online')==0)
				        continue;

				        str2 +='<div class="primary_block">';
						str2 +='<div class="ui-grid-solo">';
						str2 +='<div class="ui-block">';
						
						str2 +='<div class="approval_block"><img src="assets/images/retailer_shop_name_icon.png" class="location_icon" /><span class="approval_email"><a href="tel:'+checkforundefined(store_namearr[i])+'" class="a_link_call_new" style="color:#32286b !important;">'+store_namearr[i]+'</a></span></div>';
						str2 +='<div class="approval_block"><img src="assets/images/retailer_shop_address_icon.png" class="location_icon"/><span class="approval_email">'+checkforundefined(store_addarr[i])+'</span></div>';
						//str2 +='<div class="approval_block"><img src="assets/images/retailer_call_icon.png" class="location_icon"/><span class="approval_email"><a href="tel:'+checkforundefined(data[i].storephone)+'" class="a_link_call_new">'+checkforundefined(data[i].storephone)+'</a></span></div>';
						str2 +='<div class="approval_block"><img src="assets/images/retailer_call_icon.png" class="location_icon"/><span class="approval_email"><a href="tel:'+checkforundefined(store_contact[i])+'" class="a_link_call_new">'+checkforundefined(store_contact[i])+'</a></span></div>';
					  ...
					  document.getElementById("store_div").innerHTML=str2;

				      $.mobile.changePage( "#stores", { transition: "none"} );
			 }
			 else
			 {
			 	toast('No nearby store found.');
    ...
    success: function(data, textStatus, xhr) {
			...
			var str1='';
				 ...
				 for (var i = 0; i < data.length; i++)
				 {
				  ...
				  if(str1=='')
				  {
						str1='<span style="text-align:center;display: block;">No store found</span>';
				  }
...
{
        /*var paytype = localStorage.getItem('paymenttypedaimler');
		if(paytype=='paytm')
		{

			localStorage.setItem('pointsredeemdaimler','0');
			$('#billing_phone').val(checkforundefined(localStorage.getItem('usernamedaimler')));
		...
		{*/
			...
			$('#txtlastname').val(checkforundefined(localStorage.getItem('lastname')));
			$('#billing_email').val(checkforundefined(localStorage.getItem('emailid')));
			$.mobile.changePage( "#payment_address");
...
function submitpayment()
{
 ...
 var products = localStorage.getItem("id_strdaimler");
 var totamt = localStorage.getItem('totalamtdaimler');
 var payamt =  localStorage.getItem('payableamtdaimler');
 var ptsredeem = localStorage.getItem('pointsredeemdaimler');
 var paytype = localStorage.getItem('paymenttypedaimler'); 
  if(paytype == undefined || paytype == null)
	 paytype='';
 var discount =  localStorage.getItem('discountdaimler');
 var deliverycharge =  localStorage.getItem('deliverychargedaimler');
 var tax =  localStorage.getItem('taxdaimler');

 var cat_type = localStorage.getItem('cattype_ad');

 var location1 = localStorage.getItem("selectedstoredaimler");
 if(location1==undefined || location1 ==null)
	 location1 = localStorage.getItem("selectedareadaimler");
 ...
 var phone= checkforundefined(localStorage.getItem('usernamedaimler'));
 ...
 var city=$('#billing_address_2').val();
 var pincode=$('#billing_address_3').val();
 var state=$('#billing_address_4').val();

 var couponcode= checkforundefined(localStorage.getItem("couponcodedaimler"));
...
/*if(localStorage.getItem("selectedareadaimler")!=undefined && localStorage.getItem("selectedareadaimler") !=null)
{
 ...
 else
 {
  ...
  $.ajax({
    ...
    success: function(data, textStatus, xhr) {
       ...
       // }
        /*localStorage.removeItem('addoncartdaimler');
        localStorage.removeItem('shoppingcartdaimler');
        localStorage.removeItem('shoppingcartitemdaimler');
		localStorage.removeItem("id_strdaimler");
		localStorage.removeItem("totalamtdaimler");
		localStorage.removeItem("payableamtdaimler");
		localStorage.removeItem("pointsredeemdaimler");
		localStorage.removeItem("paymenttypedaimler");
		localStorage.removeItem("discountdaimler");
		localStorage.removeItem("couponcodedaimler");
		localStorage.removeItem("deliverychargedaimler");
		localStorage.removeItem("selectedstoredaimler");
		localStorage.removeItem("selectedareadaimler");*/
